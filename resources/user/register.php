...
<form class="max-w-sm mx-auto" method="post" action="">
    ...
    <div class="mb-5">
        ...
        <input value="<?= old('name') ?>" name="name" type="text" id="name"
               ...
               <?= set_validation_class('name') ?>  "
               placeholder="Name"/>
        <div class="text-red-800"><?= get_errors('name') ?></div>
    </div>
    <div class="mb-5">
    ...
    <div class="mb-5">
        ...
        <input name="confirmPassword" type="password" id="confirmPassword"
               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
               <?= set_validation_class('confirmPassword') ?>  "/>
        <div class="text-red-800"><?= get_errors('confirmPassword') ?></div>
    </div>
    <button type="submit"
